 ...
 private:
  ...
  void testSerializeDeserialize() {
...

    {
      ...
      assert(deserializedPlant != nullptr &&
             "Test 4.1 failed: Deserialization returned nullptr");
      assert(deserializedPlant->getName() == "Cherry" &&
             "Test 4.2 failed: Incorrect name after deserialization");
      assert(deserializedPlant->getPrice() == 3 &&
             "Test 4.3 failed: Incorrect buy price after deserialization");
      assert(deserializedPlant->getSellPrice() == 7 &&
             "Test 4.4 failed: Incorrect sell price after deserialization");
